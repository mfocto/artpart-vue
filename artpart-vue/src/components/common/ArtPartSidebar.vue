    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="resident-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">민원신청</a></li>
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">내 민원 조회</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse" id="member-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">회의/투표/설문</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse" id="car-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">내 차량 등록</a></li>
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">방문차량 등록</a></li>
          </ul>
        </div>
      </li>
    </ul>
