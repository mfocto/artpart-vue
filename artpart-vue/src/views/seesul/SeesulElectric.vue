        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <tr>
              ...
              <td>{{ electricResults[0] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[1] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[2] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[3] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[4] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[5] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              <td rowspan="2">차단기</td>
              <td style="text-align:left;">외부접속부의 과열, 변색여부</td>
              <td>{{ electricResults[6] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[7] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[8] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[9] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[10] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[11] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[12] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[13] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[14] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[15] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[16] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[17] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[18] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[19] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[20] === 'Y' ? '양호' : '불량' }}</td>
            ...
            <tr>
              ...
              <td>{{ electricResults[21] === 'Y' ? '양호' : '불량' }}</td>
