<template>
  <div>
    <div align="left" className="jb-header">
      <h1>직원 관리</h1>
    </div>
  ...
  <br>
  <br>
  <div align="left" className="jb-header"><h2>직원등록</h2>
  </div>
    ...
    <table style="width:100%; border : 1px solid #000 ;">
      ...
      <tr style="border : 1px solid #000 ;">
        ...
        <td style="margin: 0; padding: 0; vertical-align:middle;">
          <select style="width: 250px; height: 30px;" id="emp_job_id" v-model="emp_job_id">
            ...
            <!--v-if="emp_department_id == '기술직-전기' || emp_department_id == '기술직-설비' || emp_department_id == '기술직-열선'" -->
      ...
      <tr style="border : 1px solid #000 ;">
        ...
        <th><input style="width:250px;height:30px;font-size: 20px;" type="date" v-model="emp_hire_date"
                   id="emp_hire_date" min="2018-01-01" max="2050-12-31"></th>
      </tr>
      <tr style="border : 1px solid #000 ;">
        <th><font size="5">퇴사일</font></th>
        <th><input style="width:250px;height:30px;font-size: 20px;" type="date" v-model="emp_departure_date"
                   id="emp_departure_date" min="2018-01-01" max="2050-12-31"></th>
      </tr>
  ...
  <div className="button1">
    <button style="float: center;" className="btn btn-dark" v-on:click="fnSave">등록</button> &nbsp;
    <button style="float: right;" type="button" className="btn btn-dark" v-on:click="fnList">목록</button>
  </div>
