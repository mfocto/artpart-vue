<template>
  <div>
    <div  align="left" class="jb-header">
      ...
      <br>
      <br>
      <div align="left" class="jb-header" ><h2>입주민 차량 상세 조회</h2> 
      </div>
      
      <div>
        <table style="width:100%; border : 1px solid #000 ;">
        <tr style="border : 1px solid #000 ;">
          <td><font size="5">아파트 명 </font></td><td><font size="5">ict 2차 아파트</font></td>
        </tr>
        <tr style="border : 1px solid #000 ;">
          <td> <font size="5">동호 </font></td><td><font size="5">101-101</font></td>
        </tr>
        <tr style="border : 1px solid #000 ;">
          <td><font size="5">입주민 전화 번호 </font></td>
          <!-- <td><input style="width:500px;height:50px;" type="text"></td> -->
          <td><font size="5">01012345678</font></td>
        </tr>
        <tr style="border : 1px solid #000 ;">
          ...
          <!-- <h1 style="margin: 0; padding: 0; vertical-align:middle;"><input style="width:40px; height:60px;" type="checkbox" name="car" value="member"> &nbsp; 입주민&nbsp; 
            ...
            <td><font size="5">입주민</font></td>
        </tr>
        <tr style="border : 1px solid #000 ;">
          <td><font size="5">차량번호</font></td>
          <!-- <td><input style="width:500px;height:50px;" type="text"></td> -->
          <td><font size="5">12가3456</font></td>
        </tr>
        <tr style="border : 1px solid #000 ;">
          <td><font size="5">차종</font></td>
          <td><font size="5">지바겐</font></td>
          <!-- <td><input style="width:500px;height:50px;" type="text"></td> -->
        </tr>
        <tr style="border : 1px solid #000 ;">
        ...
        <tr style="border : 1px solid #000 ;">
          ...
          <th><font size="5">2022.04.26</font></th>
        </tr>
        </table>
      </div>
      <br>
      <br>
      <div class="button1">
            <button style="float: center;" type="button" class="btn btn-dark"><router-link to="/memberCarChange">수정</router-link></button> &nbsp; 
