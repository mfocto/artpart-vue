      ...
      <tr style="border : 1px solid #000 ;">
        ...
        <td style="margin: 0; padding: 0; vertical-align:middle;">
          <h1 style="margin: 0; padding: 0; vertical-align:middle;">
            ...
            <input style="width:40px; height:60px " type="radio" id="car_division_id" name="출입체한" value="출입제한" v-model="car_division_id"> &nbsp; 출입제한
          </h1>
        </td>
      </tr>
  ...
  methods: {
    ...
    fnSave() {
      ...
      this.form = {
        ...
        // emp_carid: this.emp_carid || null,
        // member_carid: this.member_carid || null
      };


      if (this.car_idx === undefined) {
        console.log(this.member_carid)
        console.log(this.form)
        // 등록
        if(this.car_division_id === '직원'){
          this.$axios.post(apiUrl+this.emp_carid, this.form)
              .then((res) => {
                alert('차량이 등록되었습니다.');
          ...
          this.$axios.post(apiUrl+this.member_carid, this.form)
              .then((res) => {
                alert('차량이 등록되었습니다.');
                this.fnView(res.data.car_idx);
              }).catch((err) => {
